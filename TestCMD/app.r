...
server =shinyServer(function(input, output, session) {
  ...
  datasetInput <- reactive({
    ...
    if (input$carb != "All"){
      dataCars <- dataCars[dataCars$carb == input$carb,]
    }
    if (input$cyl != "All"){
      dataCars <- dataCars[dataCars$cyl == input$cyl,]
    }
    if (input$am != "All"){
      dataCars <- dataCars[dataCars$am == input$am,]
    }
    dataCars
  })
  ...
  output$downloadData <- downloadHandler(
    ...
    filename = function(){ paste('Export',Sys.Date(), '.csv', sep='')},
...
ui <- shinyUI(navbarPage("Milwaukee Power and Gas Company",
                        
                         tabPanel("Home Metrics",
                                  ...
                                  sidebarLayout(
                                    ...
                                    sidebarPanel(
                                      ...
                                      selectInput("carb", 
                                                      "Carb:", 
                                                      c("All", 
                                                        sort(unique(as.numeric(mtcars$carb)))))
                                      ,
                                      ...
                                      selectInput("cyl", 
                                                      "Cylinders:", 
                                                      c("All", 
                                                        sort(unique(as.character(mtcars$cyl)))))
                                      ,      
