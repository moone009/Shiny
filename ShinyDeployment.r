...
library(devtools)
library(shinyapps)
shinyapps::setAccountInfo(name='christophertestaccount', 
                          token='536271AF8A8758538E61F3936668602D', 
                          secret='rBNd7byxFD2B5gbxzOuzXz/a2PAMxxdZrgBeH5qh')

# Directory of Server and UI
ShinyWorkingDirectory = 'F:/Shiny/SampleDashboard'
# Deploy to shiny
...
## https://groups.google.com/forum/#!topic/shiny-discuss/r-4stY3xTy0
